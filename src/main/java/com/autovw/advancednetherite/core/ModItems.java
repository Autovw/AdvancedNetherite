...
public class ModItems {
    ...
    // Ingots
    public static final RegistryObject<Item> NETHERITE_IRON_INGOT = register("netherite_iron_ingot", new Item(new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE)));
    public static final RegistryObject<Item> NETHERITE_GOLD_INGOT = register("netherite_gold_ingot", new Item(new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE)));
    public static final RegistryObject<Item> NETHERITE_EMERALD_INGOT = register("netherite_emerald_ingot", new Item(new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE)));
    public static final RegistryObject<Item> NETHERITE_DIAMOND_INGOT = register("netherite_diamond_ingot", new Item(new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE)));
