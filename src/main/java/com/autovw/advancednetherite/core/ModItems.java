...
public class ModItems {
    ...
    // ARMOR SETS
    // Netherite/Iron
    public static final RegistryObject<Item> NETHERITE_IRON_HELMET = register("netherite_iron_helmet", new NetheriteIronArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.HEAD, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_IRON_CHESTPLATE = register("netherite_iron_chestplate", new NetheriteIronArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.CHEST, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_IRON_LEGGINGS = register("netherite_iron_leggings", new NetheriteIronArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.LEGS, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_IRON_BOOTS = register("netherite_iron_boots", new NetheriteIronArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.FEET, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));

    // Netherite/Gold
    public static final RegistryObject<Item> NETHERITE_GOLD_HELMET = register("netherite_gold_helmet", new NetheriteGoldArmorItem(ModArmorTiers.NETHERITE_GOLD, EquipmentSlotType.HEAD, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_GOLD_CHESTPLATE = register("netherite_gold_chestplate", new NetheriteGoldArmorItem(ModArmorTiers.NETHERITE_GOLD, EquipmentSlotType.CHEST, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_GOLD_LEGGINGS = register("netherite_gold_leggings", new NetheriteGoldArmorItem(ModArmorTiers.NETHERITE_GOLD, EquipmentSlotType.LEGS, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_GOLD_BOOTS = register("netherite_gold_boots", new NetheriteGoldArmorItem(ModArmorTiers.NETHERITE_GOLD, EquipmentSlotType.FEET, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));

    // Netherite/Emerald
    public static final RegistryObject<Item> NETHERITE_EMERALD_HELMET = register("netherite_emerald_helmet", new NetheriteEmeraldArmorItem(ModArmorTiers.NETHERITE_EMERALD, EquipmentSlotType.HEAD, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_EMERALD_CHESTPLATE = register("netherite_emerald_chestplate", new NetheriteEmeraldArmorItem(ModArmorTiers.NETHERITE_EMERALD, EquipmentSlotType.CHEST, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_EMERALD_LEGGINGS = register("netherite_emerald_leggings", new NetheriteEmeraldArmorItem(ModArmorTiers.NETHERITE_EMERALD, EquipmentSlotType.LEGS, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_EMERALD_BOOTS = register("netherite_emerald_boots", new NetheriteEmeraldArmorItem(ModArmorTiers.NETHERITE_EMERALD, EquipmentSlotType.FEET, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));

    // Netherite/Diamond
    public static final RegistryObject<Item> NETHERITE_DIAMOND_HELMET = register("netherite_diamond_helmet", new NetheriteDiamondArmorItem(ModArmorTiers.NETHERITE_DIAMOND, EquipmentSlotType.HEAD, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_DIAMOND_CHESTPLATE = register("netherite_diamond_chestplate", new NetheriteDiamondArmorItem(ModArmorTiers.NETHERITE_DIAMOND, EquipmentSlotType.CHEST, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_DIAMOND_LEGGINGS = register("netherite_diamond_leggings", new NetheriteDiamondArmorItem(ModArmorTiers.NETHERITE_DIAMOND, EquipmentSlotType.LEGS, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_DIAMOND_BOOTS = register("netherite_diamond_boots", new NetheriteDiamondArmorItem(ModArmorTiers.NETHERITE_DIAMOND, EquipmentSlotType.FEET, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
