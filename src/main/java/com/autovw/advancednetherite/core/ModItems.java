...
public class ModItems {
    ...
    // ARMOR SETS
    // Netherite/Iron
    public static final RegistryObject<Item> NETHERITE_IRON_HELMET = register("netherite_iron_helmet", new AdvancedArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.HEAD, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_IRON_CHESTPLATE = register("netherite_iron_chestplate", new AdvancedArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.CHEST, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_IRON_LEGGINGS = register("netherite_iron_leggings", new AdvancedArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.LEGS, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
    public static final RegistryObject<Item> NETHERITE_IRON_BOOTS = register("netherite_iron_boots", new AdvancedArmorItem(ModArmorTiers.NETHERITE_IRON, EquipmentSlotType.FEET, (new Item.Properties().tab(Reference.TAB_ADVANCEDNETHERITE))));
