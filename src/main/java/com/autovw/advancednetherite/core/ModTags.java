...
public class ModTags {
    ...
    public static final Tag.Named<Item> INGOTS_NETHERITE_DIAMOND = bindModTag("ingots/netherite_diamond");
    public static final Tag.Named<Item> INGOTS_NETHERITE_EMERALD = bindModTag("ingots/netherite_emerald");
    public static final Tag.Named<Item> INGOTS_NETHERITE_GOLD = bindModTag("ingots/netherite_gold");
    public static final Tag.Named<Item> INGOTS_NETHERITE_IRON = bindModTag("ingots/netherite_iron");
    public static final Tag.Named<Item> INGOTS_NETHERITE = bindModTag("ingots/netherite");
