...
public class ModLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        addOreDrop(Reference.MOD_ID, Blocks.GOLD_ORE, ModItems.NETHERITE_GOLD_PICKAXE.get(), Items.GOLD_NUGGET, 0.3f, 1, 3);
        addOreDrop(Reference.MOD_ID, Blocks.IRON_ORE, ModItems.NETHERITE_IRON_PICKAXE.get(), Items.IRON_NUGGET, 0.2f, 1, 4);
