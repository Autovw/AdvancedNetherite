...
public class ModRecipeProvider extends RecipeProvider {
     ...
     */
    public static void baseSmithingRecipe(Consumer<IFinishedRecipe> consumer, ITag.INamedTag<Item> ingredient, ITag.INamedTag<Item> upgradeIngredient, Item result) {
        SmithingRecipeBuilder.smithing(Ingredient.of(ingredient), Ingredient.of(upgradeIngredient), result)
     ...
     */
    public static void baseIngotRecipe(Consumer<IFinishedRecipe> consumer, ITag.INamedTag<Item> ingotIngredient, ITag.INamedTag<Item> upgradeIngredient, Item result) {
     ...
     * @param result Block
     */
    public static void baseBlockRecipe(Consumer<IFinishedRecipe> consumer, IItemProvider ingredient, Block result) {
        // Items to Block
    ...
    private static void lodestoneRecipe(Consumer<IFinishedRecipe> consumer) {
