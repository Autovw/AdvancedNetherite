...
public class AdvancedShovelItem extends ShovelItem {
    ...
    public AdvancedShovelItem(IItemTier tier, float attackDamage, float attackSpeed, Properties properties) {
    ...
    /**
     * Use {@link AdvancedShovelItem#addTooltips(ItemStack, World, List, ITooltipFlag)} instead
     */
    @Deprecated
    ...
    /**
     * Don't override this method, use {@link AdvancedShovelItem#addTooltips(ItemStack, List, ITooltipFlag)} if you want to add your own custom tooltips.
     */
    @Override
