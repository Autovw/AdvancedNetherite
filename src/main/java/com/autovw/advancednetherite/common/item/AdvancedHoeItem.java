...
public class AdvancedHoeItem extends HoeItem {
    ...
    public AdvancedHoeItem(IItemTier tier, int attackDamage, float attackSpeed, Properties properties) {
    ...
    /**
     * Use {@link AdvancedHoeItem#addTooltips(ItemStack, World, List, ITooltipFlag)} instead
     */
    @Deprecated
