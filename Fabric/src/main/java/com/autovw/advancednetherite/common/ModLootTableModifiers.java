...
public final class ModLootTableModifiers
{
    ...
    private static LootPool.Builder cropDropPool(Block cropBlock, Property<?> ageProperty, float dropChance, ItemLike dropItem, int minDrop, int maxDrop)
    {
        ...
        return LootPool.lootPool()
            ...
            .when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(ModTags.DROPS_ADDITIONAL_CROPS)))
    ...
    private static LootPool.Builder oreDropPool(HolderLookup.Provider registryProvider, float dropChance, Item dropItem, int minDrop, int maxDrop, TagKey<Item> toolTag)
    {
        ...
        return LootPool.lootPool()
                .when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(toolTag)))
