...
public class ModAdvancementProvider extends FabricAdvancementProvider
{
    ...
    public void generateAdvancement(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer)
    {
        Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "husbandry/obtain_netherite_diamond_hoe"));
        ...
        AdvancementHolder netheriteIronArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_iron_armor"));
        ...
        AdvancementHolder netheriteGoldArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_gold_armor"));
        ...
        AdvancementHolder netheriteEmeraldArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_emerald_armor"));
        ...
        Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_diamond_armor"));
        ...
        AdvancementHolder netheriteIronIngot = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/obtain_netherite_iron_ingot"));
        ...
        Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/obtain_netherite_diamond_block"));
    }
}
