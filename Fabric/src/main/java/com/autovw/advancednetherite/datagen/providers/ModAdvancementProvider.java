...
public class ModAdvancementProvider extends FabricAdvancementProvider
{
    ...
    public void generateAdvancement(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer)
    {
        Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "husbandry/obtain_netherite_diamond_hoe").toString());
        ...
        AdvancementHolder netheriteIronArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_iron_armor").toString());
        ...
        AdvancementHolder netheriteGoldArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_gold_armor").toString());
        ...
        AdvancementHolder netheriteEmeraldArmor = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_emerald_armor").toString());
        ...
        Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_diamond_armor").toString());
        ...
        AdvancementHolder netheriteIronIngot = Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/obtain_netherite_iron_ingot").toString());
        ...
        Advancement.Builder.advancement()
                ...
                .save(consumer, Identifier.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/obtain_netherite_diamond_block").toString());
    }
}
