    ...
    public static class ModNetherAdvancements implements AdvancementGenerator
    {
        ...
        public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> consumer, ExistingFileHelper fileHelper)
        {
            Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "husbandry/obtain_netherite_diamond_hoe"));
            ...
            AdvancementHolder netheriteIronArmor = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_iron_armor"));
            ...
            AdvancementHolder netheriteGoldArmor = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_gold_armor"));
            ...
            AdvancementHolder netheriteEmeraldArmor = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_emerald_armor"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/netherite_diamond_armor"));
            ...
            AdvancementHolder netheriteIronIngot = Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/obtain_netherite_iron_ingot"));
            ...
            Advancement.Builder.advancement()
                    ...
                    .save(consumer, ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "nether/obtain_netherite_diamond_block"));
        }
    }
}
