...
public class DetailArmorBarSupport {
    protected static final ResourceLocation ARMOR_BAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(AdvancedNetherite.MOD_ID, "textures/armor_bar/armor_bar.png");
